...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2021 at 07:35 PM
...
CREATE TABLE `orders` (
  ...
  `date` date NOT NULL,
  `order_status` enum('pending','paid','cancel') NOT NULL DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `orders` (`id`, `company_id`, `vender_id`, `gross_total`, `discount`, `sub_total`, `cgst`, `sgst`, `igst`, `igst_amount`, `sgst_amount`, `cgst_amount`, `net_amount`, `date`, `order_status`) VALUES
(1, 1, 2, 0, 5, 0, 0, 0, 18, 15957, 0, 0, 104611, '2021-01-03', 'cancel'),
(2, 1, 1, 93320, 5, 0, 9, 9, 0, 0, 7978, 7978, 104610, '2021-01-03', 'pending'),
(3, 1, 1, 93320, 5, 0, 0, 0, 18, 15957, 0, 0, 104611, '2021-01-03', 'pending'),
(4, 1, 1, 93320, 5, 88654, 0, 0, 18, 15957, 0, 0, 104611, '2021-01-03', 'pending'),
(5, 1, 1, 93320, 5, 88654, 9, 9, 0, 0, 7978, 7978, 104610, '2021-01-13', 'pending');
...
INSERT INTO `order_items` (`id`, `order_id`, `product_name`, `product_qty`, `product_price`) VALUES
(1, 1, 'test1', 1, 50000),
(2, 1, 'test2', 4, 43320),
(3, 2, 'ddd', 1, 93320),
(4, 3, 'ddd', 2, 93320),
